...
ActiveRecord::Schema.define(version: 20190609151646) do
  ...
  add_index "tags_things", ["tag_id", "thing_id"], name: "index_tags_things_on_tag_id_and_thing_id", unique: true, using: :btree
